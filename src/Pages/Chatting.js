...
const Chatting = () => {
    return (
        <div>
            <div className='my-12'>
                <div class="navbar bg-gray-600 rounded-full">
                    <div class="flex-1">
                        <div class="dropdown dropdown-start flex">
                            ...
                            <div><p className='pl-2 text-white'>Name</p>
                                <p className='pl-2 text-white'>Online</p></div>
